    ...
    for i in range(np.size(test_X,0)):
        ...
        if classifier1 == 1:
            ...
            if classifier2 == 1:
                ...
                classifier3 = calculateClassifier(test_X[i,:],listClass[0], listClass[3])   
                if classifier3 == 1:
                    classSeparated.append(totalClass[0]) 
                else:
                    classSeparated.append(totalClass[3]) 
            else:
                classifier3 = calculateClassifier(test_X[i,:],listClass[2], listClass[3])   
                if classifier3 == 1:
            ...
            classifier2 = calculateClassifier(test_X[i,:],listClass[1], listClass[2])
            #print "classifier - 3", classifier3
            if classifier2 == 1:
                #compare class 2 and 4
                classifier3 = calculateClassifier(test_X[i,:],listClass[1], listClass[3])   
                if classifier3 == 1:
